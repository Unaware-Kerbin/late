...
| 5.3 | Segregation of duties | P | CC6.1 | Dual-gate agent vs human terminal; single maintainer residual |
...
| 5.19–5.23 | Suppliers | P | CC9 | Supplier register; cloud chat opt-in |
...
| 8.2 | Privileged access | P | CC6 | Sidecar token; no app RBAC |
| 8.3 | Information access | P | CC6 | 0600 vaults, 0700 dirs |
| 8.5 | Secure authentication | P | CC6 | Token + loopback Host; no MFA |
| 8.8 | Technical vulnerabilities | P | CC7.5 | Isolation CI + advisory scans |
| 8.9 | Configuration | P | CC8 | settings.toml; cloud flag |
| 8.15 | Logging | P | CC7 | audit.jsonl method/ok/actor/egress; not WORM |
| 8.16 | Monitoring | P | CC7 | Local log only |
| 8.20–8.22 | Networks | P | CC6.6 | Loopback bind; CORS not auth |
| 8.24 | Cryptography | P | C1 | TLS/SSH in transit; at rest chmod; XOR not encryption |
