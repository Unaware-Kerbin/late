...
Download from **[Releases](https://github.com/Unaware-Kerbin/late/releases)** (latest app tag is [v0.1.16](https://github.com/Unaware-Kerbin/late/releases/tag/v0.1.16)). Pick the file for **your computer**:
...
Example Mac name: `Late-0.1.16-mac-arm64.zip`. The number matches the GitHub tag. These files are unsigned. SSH still uses the `ssh` program already on your computer.
