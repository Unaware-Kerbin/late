...
The easy way: download a ready-made app from **[Releases](https://github.com/Unaware-Kerbin/late/releases)** (latest app tag is [v0.1.8](https://github.com/Unaware-Kerbin/late/releases/tag/v0.1.8)). Pick the file that matches your computer:
